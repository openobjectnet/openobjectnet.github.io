...
(composition-api 방식에서는 setup 메서드 내에서 computed를 사용하고, 코드가 그리 복잡하지 않기 때문에 Vuex Helpers를 사용하지 않는 것이 좋습니다.)   

![not_helpers_example_1](/assets/images/vue3-composition-api/not_helpers_example_1.PNG)
